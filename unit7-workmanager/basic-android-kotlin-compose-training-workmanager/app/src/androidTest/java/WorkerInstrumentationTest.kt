...
class WorkerInstrumentationTest {
    ...
    private val mockUri = KEY_IMAGE_URI to "android.resource://com.example.bluromatic/drawable/android_cupcake"
    ...
    fun blurWorker_doWork_resultSuccessReturnsUri() {
        ...
        runBlocking {
            ...
            assertTrue(resultUri?.startsWith("file:///data/user/0/com.example.bluromatic/files/blur_filter_outputs/blur-filter-output-") == true)
        }
    }
